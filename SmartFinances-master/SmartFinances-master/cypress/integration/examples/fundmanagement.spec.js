describe("Test case flow fund management", () => {
    it('visit admin page', () => {
        ...
        it("should check whether Manage Existing fund is working or not", () => {
          ...
          cy.contains('Fund Description:"This is a fund for you to invest if you are looking for optimal risk positions and returns with balanced risk factor"').should("be.visible")
        });
