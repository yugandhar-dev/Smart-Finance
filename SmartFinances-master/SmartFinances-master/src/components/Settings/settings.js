...
import {getUserDetails, getProfileSettings, getEmailId, getUserPhoneNumber} from '../../auth/index';
...
export default()=>{
    ...
    const changePwd = (
        <div>
            ...
            onChange={event => getCurrentPassword(event.target.value)} >Current Password</TextField>
            </ListItem>
            <ListItem>
            ...
            required="required" 
            value={newpassword}
            onChange ={event => getNewPassword(event.target.value)}>Change Password</TextField>
            </ListItem>
        </div>
    );
    const changeMobile = (
        <div>
            <ListItem>
                <TextField label = "New Mobile Number"
